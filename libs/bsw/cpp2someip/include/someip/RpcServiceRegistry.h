...
{
public:
    RpcServiceRegistry(ServiceManager& serviceManager, ServiceTracker& serviceTracker);
    ...
    void serviceTrackerChanged(ServiceDescription const&, ServiceTrackerStatus const) override {}
