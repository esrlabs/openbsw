...
public:
    ...
    void enterIsrGroup(size_t const isrGroupIdx ESR_UNUSED) {}

    void leaveIsrGroup(size_t const isrGroupIdx ESR_UNUSED) {}

    void enterFunction(FunctionEntryType& functionEntry ESR_UNUSED) const {}

    void leaveFunction(FunctionEntryType& functionEntry ESR_UNUSED) const {}
