...
private:
    ...
    static constexpr size_t TX_QUEUE_SIZE_BYTES   = TX_NUM_ELEMENTS * TX_ELEMENT_SIZE_BYTES;

    using TxQueue = ::io::MemoryQueue<TX_QUEUE_SIZE_BYTES, TX_ELEMENT_SIZE_BYTES>;
